...
def Principle_Components(data,n):
    scaler = StandardScaler()
    data = scaler.fit_transform(data)  # Normalize the data first for  Principal component analysis
    pca = PCA(n_components=n)
    data_set_PCA = pca.fit_transform(data)
    return data_set_PCA
